...
angular.module('tcl').controller('TableListCtrl', function ($scope, $rootScope, Restangular, $filter, $http, $modal, $timeout, CloneDeleteSvc) {
...
angular.module('tcl').controller('TableModalCtrl', function ($scope) {
...
angular.module('tcl').controller('ConfirmValueSetDeleteCtrl', function ($scope, $modalInstance, tableToDelete, $rootScope) {
...
angular.module('tcl').controller('ValueSetReferencesCtrl', function ($scope, $modalInstance, tableToDelete) {
