angular.module('tcl').controller('MessageController', function ($document, $scope, $rootScope, $templateCache, Restangular, $http, $filter, $mdDialog, $modal, $cookies, $timeout, userInfoService, ngTreetableParams, $interval, ViewSettings, StorageService, $q, notifications, IgDocumentService, ElementUtils,AutoSaveService,$sce,Notification,IgamtResourceGetter) {
    ...
    $rootScope.rowUsage=function (obj) {
        return obj.usage;
    };
    $rootScope.rowCard=function (obj) {
        return "["+obj.min+','+obj.max+"]";
    };
    $rootScope.rowLength=function (obj) {
        return "["+obj.minLength+','+obj.maxLength+"]";
    };
    $rootScope.hasLength=function (obj) {
        return obj.minLength&&obj.maxLength;
    };
    $rootScope.rowConfLength=function (obj) {
        return obj.confLength;
    };
    $rootScope.hasConfLength=function (obj) {
        return obj.confLength;
    }
    $rootScope.rowDatatype=function (obj) {
        if(obj.datatype){
            return $scope.getLabelOfObject($rootScope.datatypesMap[obj.datatype.id]);
        }
    };
    $rootScope.hasDatatype=function (obj) {
            return obj.datatype;
    };
    $rootScope.rowValueSetBindings=function (obj) {

    };
    $rootScope.rowPredicates=function (obj) {
        //$scope.findPredicates(obj);
    };
    $rootScope.rowConstantValue=function (obj) {
        //$scope.findPredicates(obj);
    };
    $rootScope.hasCoConstraint=function (obj) {
    };
    $rootScope.hasDynamicMapping=function (obj) {
    };
    ...
    $scope.showDynamicMapping = function(segment) {
        var modalInstance = $mdDialog.show({
            templateUrl: 'dynamicMapping.html',
            controller: 'DynamicMapping',
            preserveScope:true,
            locals: {
                segment:segment
            }
