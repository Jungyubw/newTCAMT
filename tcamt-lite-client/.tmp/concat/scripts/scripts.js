...
angular.module('tcl').controller('ViewIGChangesCtrl', ["$scope", "$modalInstance", "changes", "$rootScope", "$http", function ($scope, $modalInstance, changes, $rootScope, $http) {
    $scope.changes = changes;
    $scope.loading = false;
    $scope.exportChanges = function () {
        $scope.loading = true;
...
angular.module('tcl').controller('ConfirmIGDocumentCloseCtrl', ["$scope", "$modalInstance", "$rootScope", "$http", function ($scope, $modalInstance, $rootScope, $http) {
    $scope.loading = false;
...
angular.module('tcl').controller('ConfirmIGDocumentOpenCtrl', ["$scope", "$modalInstance", "igdocumentToOpen", "$rootScope", "$http", function ($scope, $modalInstance, igdocumentToOpen, $rootScope, $http) {
...
angular.module('tcl').controller('SelectMessagesOpenCtrl', ["$scope", "$modalInstance", "igdocumentToSelect", "$rootScope", "$http", "$cookies", function ($scope, $modalInstance, igdocumentToSelect, $rootScope, $http, $cookies) {
...
angular.module('tcl').controller('AddTableOpenCtrl', ["$scope", "$modalInstance", "igdocumentToSelect", "$rootScope", "$http", "$cookies", function ($scope, $modalInstance, igdocumentToSelect, $rootScope, $http, $cookies) {
	$scope.loading = false;
	$scope.igdocumentToSelect = igdocumentToSelect;
	$scope.source = '';
